...
public class Data01Activity extends Activity {
	...
	private static final int[] IDS = { R.id.id_listview,
			R.id.datetime_listview, R.id.note_listview };
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.insert_menu:
			...
			startActivityForResult(intentInsert, INSERT_REQUEST_CODE);// 因為要取得回傳資料並刷新畫面
			break;
		// 搜尋
		case R.id.search_menu:
			Intent intentSearch = new Intent(this, SearchActivity.class);
			startActivityForResult(intentSearch, SEARCH_REQUEST_CODE);// 因為要取得回傳資料並刷新畫面
			break;
		}
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case R.id.update_menu:
			...
			startActivityForResult(intentUpdate, UPDATE_REQUEST_CODE);// 因為要取得回傳資料並刷新畫面
			break;
		// 刪除資料
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == Activity.RESULT_OK) {
			...
			if (requestCode == SEARCH_REQUEST_CODE) {
				...
				//SimpleCursorAdapter是DB專用的Adapter
				SimpleCursorAdapter sca = new SimpleCursorAdapter(this,
						R.layout.listview_place, cursor, placeDAO.SHOW_COLUMNS,
						IDS, CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER);
	...
	private void refresh() {
		...
		// 第六個參數指定為CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER
		SimpleCursorAdapter sca = new SimpleCursorAdapter(this,
				R.layout.listview_place, cursor, PlaceDAO.SHOW_COLUMNS, IDS,
